public class Karyawan
{
   ...
   public Karyawan ()
   {
      ...
      ((Komisi) staffList[6]).addHours(35); // Karyawan komisi pertama bekerja 35 jam
      ((Komisi) staffList[6]).addSales(400); // Total penjualan pertama sebesar $400
      ((Komisi) staffList[7]).addHours(40); // Karyawan komisi kedua bekerja 40 jam
   ...
   public void payday() {
      for (DaftarPegawai staffMember : staffList) {
          ...
          double amount = staffMember.pay();  // Mendapatkan pembayaran
